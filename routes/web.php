...
Route::post('/formEdad', [EdadController::class, 'enviarEdad']) -> name('formEdad.enviar') -> middleware(VerificarEdad::class);
...
Route::get('/adolescentes', [AdolescenteController::class, 'index']) -> name('adolecente.index');
